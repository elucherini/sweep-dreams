-- Migration: Re-apply schedules_near with is_user_side
-- This re-applies the schedules_near function with is_user_side detection,
-- reverting from the side_geometry version.
